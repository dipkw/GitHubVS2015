...
namespace dipndipInventory
{
    public partial class dipndipInventoryContext : OpenAccessContext
    {
        static MetadataContainer metadataContainer = new dipndipInventoryMetadataSource().GetModel();
        ...
        public dipndipInventoryContext()
