namespace dipndipTLReports
{
    ...
    /// <summary>
    /// Summary description for PrintOrderReport.
    /// </summary>
    public partial class PrintOrderReport : Telerik.Reporting.Report
    {
        ...
        public PrintOrderReport(string order_no)
        {
            InitializeComponent();
        ...
        private void SalesBill_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.PrintOrderSqlDataSource.Parameters[0].Value = report.Parameters["order_no"].Value;

            // Set the SqlDataSource component as it's DataSource
            report.DataSource = this.PrintOrderSqlDataSource;
        }
    }
}